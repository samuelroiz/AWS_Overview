...
export class EC2Create extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    super(scope, id, props);

        // connect LogGroup
        const logGroup = logs.LogGroup.fromLogGroupName(this, 'EC2LogGroup', '/aws/ec2/my-instance-logs');
        ...
        const def_EC2Instance = new ec2.Instance(this, 'EC2Instance', {
        ...
        const cpuUtilizationMetric = new cloudwatch.Metric({
          ...
          dimensionsMap: {
            InstanceId: def_EC2Instance.instanceId // Replace with your EC2 Instance ID
          },
